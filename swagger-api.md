...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||IPage«Category»|IPage«Category»|
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||IPage«DishDto»|IPage«DishDto»|
|&emsp;&emsp;current||integer(int64)||
|&emsp;&emsp;hitCount||boolean||
|&emsp;&emsp;pages||integer(int64)||
...
| -------- | -------- | ----- | -------- | -------- | ------ |
|ids|ids|query|true|array|integer|
|state|state|path|true|integer(int32)||
|creationTime||query|false|integer(int64)||
|id||query|false|string||
|lastAccessedTime||query|false|integer(int64)||
|maxInactiveInterval||query|false|integer(int32)||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|parent|parent|path|true|string||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||IPage«Employee»|IPage«Employee»|
|&emsp;&emsp;current||integer(int64)||
|&emsp;&emsp;hitCount||boolean||
|&emsp;&emsp;pages||integer(int64)||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|beginTime|beginTime|query|false|string(date-time)||
|endTime|endTime|query|false|string(date-time)||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||IPage«Orders»|IPage«Orders»|
|&emsp;&emsp;current||integer(int64)||
|&emsp;&emsp;hitCount||boolean||
|&emsp;&emsp;pages||integer(int64)||
|&emsp;&emsp;records||array|Orders|
|&emsp;&emsp;&emsp;&emsp;address||string||
|&emsp;&emsp;&emsp;&emsp;addressBookId||integer||
|&emsp;&emsp;&emsp;&emsp;amount||number||
|&emsp;&emsp;&emsp;&emsp;checkoutTime||string||
|&emsp;&emsp;&emsp;&emsp;consignee||string||
|&emsp;&emsp;&emsp;&emsp;id||integer||
|&emsp;&emsp;&emsp;&emsp;number||string||
|&emsp;&emsp;&emsp;&emsp;orderTime||string||
|&emsp;&emsp;&emsp;&emsp;payMethod||integer||
|&emsp;&emsp;&emsp;&emsp;phone||string||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||IPage«OrdersDto»|IPage«OrdersDto»|
|&emsp;&emsp;current||integer(int64)||
|&emsp;&emsp;hitCount||boolean||
|&emsp;&emsp;pages||integer(int64)||
|&emsp;&emsp;records||array|OrdersDto|
|&emsp;&emsp;&emsp;&emsp;address||string||
|&emsp;&emsp;&emsp;&emsp;addressBookId||integer||
|&emsp;&emsp;&emsp;&emsp;amount||number||
|&emsp;&emsp;&emsp;&emsp;checkoutTime||string||
...
|&emsp;&emsp;&emsp;&emsp;id||integer||
|&emsp;&emsp;&emsp;&emsp;number||string||
|&emsp;&emsp;&emsp;&emsp;orderDetails||array|OrderDetail|
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;amount||number||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;dishFlavor||string||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;dishId||integer||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;id||integer||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;image||string||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;name||string||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;number||integer||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;orderId||integer||
|&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;setmealId||integer||
|&emsp;&emsp;&emsp;&emsp;orderTime||string||
|&emsp;&emsp;&emsp;&emsp;payMethod||integer||
|&emsp;&emsp;&emsp;&emsp;phone||string||
|&emsp;&emsp;&emsp;&emsp;remark||string||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||IPage«SetmealDto»|IPage«SetmealDto»|
|&emsp;&emsp;current||integer(int64)||
|&emsp;&emsp;hitCount||boolean||
|&emsp;&emsp;pages||integer(int64)||
